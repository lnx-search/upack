...
pub unsafe fn from_u1(input: *const u8) -> [__m256i; 4] {
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u2(input: *const u8) -> [__m256i; 4] {
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u3(input: *const u8) -> [__m256i; 4] {
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u4(input: *const u8) -> [__m256i; 4] {
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u5(input: *const u8) -> [__m256i; 4] {
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u6(input: *const u8) -> [__m256i; 4] {
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u7(input: *const u8) -> [__m256i; 4] {
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u8(input: *const u8) -> [__m256i; 4] {
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u9(input: *const u8) -> [__m256i; 4] {
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u10(input: *const u8) -> [__m256i; 4] {
    let lo_bits = unsafe { load_si256x2(input.add(0)) };
    let lo_bits = unpack_u8_to_u16_unordered(lo_bits);
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u11(input: *const u8) -> [__m256i; 4] {
    let lo_bits = unsafe { load_si256x2(input.add(0)) };
    let lo_bits = unpack_u8_to_u16_unordered(lo_bits);
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u12(input: *const u8) -> [__m256i; 4] {
    let lo_bits = unsafe { load_si256x2(input.add(0)) };
    let lo_bits = unpack_u8_to_u16_unordered(lo_bits);
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u13(input: *const u8) -> [__m256i; 4] {
    let lo_bits = unsafe { load_si256x2(input.add(0)) };
    let lo_bits = unpack_u8_to_u16_unordered(lo_bits);
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u14(input: *const u8) -> [__m256i; 4] {
    let lo_bits = unsafe { load_si256x2(input.add(0)) };
    let lo_bits = unpack_u8_to_u16_unordered(lo_bits);
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u15(input: *const u8) -> [__m256i; 4] {
    let lo_bits = unsafe { load_si256x2(input.add(0)) };
    let lo_bits = unpack_u8_to_u16_unordered(lo_bits);
...
/// - The runtime CPU must support the `avx2` instructions.
pub unsafe fn from_u16(input: *const u8) -> [__m256i; 4] {
    unsafe { load_si256x4(input.add(0)) }
}
...
mod tests {
    use super::*;
    use crate::X64;
    use crate::uint16::avx2::pack_x64_full::*;
    #[cfg(feature = "avx512")]
    ...
    fn test_saturated_unpack(
        #[case] bit_len: u8,
        #[case] unpacker: unsafe fn(*const u8) -> [__m256i; 4],
    ) {
