...
pub(crate) unsafe fn to_u1(out: *mut u8, block: [__m256i; 4]) {
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u2(out: *mut u8, block: [__m256i; 4]) {
    let partially_packed = pack_u16_to_u8_unordered(block);
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u3(out: *mut u8, block: [__m256i; 4]) {
    let partially_packed = pack_u16_to_u8_unordered(block);
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u4(out: *mut u8, block: [__m256i; 4]) {
    let partially_packed = pack_u16_to_u8_unordered(block);
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u5(out: *mut u8, block: [__m256i; 4]) {
    let partially_packed = pack_u16_to_u8_unordered(block);
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u6(out: *mut u8, block: [__m256i; 4]) {
    let partially_packed = pack_u16_to_u8_unordered(block);
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u7(out: *mut u8, block: [__m256i; 4]) {
    let partially_packed = pack_u16_to_u8_unordered(block);
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u8(out: *mut u8, block: [__m256i; 4]) {
    let partially_packed = pack_u16_to_u8_unordered(block);
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u9(out: *mut u8, block: [__m256i; 4]) {
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u10(out: *mut u8, block: [__m256i; 4]) {
    let (hi, lo) = split_u16_unordered(block);
    unsafe { store_si256x2(out.add(0), lo) };
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u11(out: *mut u8, block: [__m256i; 4]) {
    let (hi, lo) = split_u16_unordered(block);
    unsafe { store_si256x2(out.add(0), lo) };
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u12(out: *mut u8, block: [__m256i; 4]) {
    let (hi, lo) = split_u16_unordered(block);
    unsafe { store_si256x2(out.add(0), lo) };
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u13(out: *mut u8, block: [__m256i; 4]) {
    let (hi, lo) = split_u16_unordered(block);
    unsafe { store_si256x2(out.add(0), lo) };
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u14(out: *mut u8, block: [__m256i; 4]) {
    let (hi, lo) = split_u16_unordered(block);
    unsafe { store_si256x2(out.add(0), lo) };
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u15(out: *mut u8, block: [__m256i; 4]) {
    let (hi, lo) = split_u16_unordered(block);
    unsafe { store_si256x2(out.add(0), lo) };
...
/// - The runtime CPU must support the `avx2` instructions.
pub(crate) unsafe fn to_u16(out: *mut u8, block: [__m256i; 4]) {
...
mod tests {
    ...
    fn test_saturation(#[case] bit_len: u8, #[case] packer: unsafe fn(*mut u8, [__m256i; 4])) {
