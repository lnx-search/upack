...
pub(crate) fn _scalar_and_u16x16(mut a: u16x16, b: u16x16) -> u16x16 {
    for i in 0..16 {
        a[i] &= b[i];
    }
    a
...
#[inline]
/// Perform a bitwise AND on the provided registers `a` and `b`.
pub(crate) fn _scalar_and_u8x32(mut a: u8x32, b: u8x32) -> u8x32 {
    for i in 0..32 {
        a[i] &= b[i];
    }
    a
...
pub(crate) fn _scalar_or_u16x16(mut a: u16x16, b: u16x16) -> u16x16 {
    for i in 0..16 {
        a[i] |= b[i];
    }
    a
...
#[inline]
/// Perform a bitwise OR on the provided registers `a` and `b`.
pub(crate) fn _scalar_or_u8x32(mut a: u8x32, b: u8x32) -> u8x32 {
    for i in 0..32 {
        a[i] |= b[i];
    }
    a
