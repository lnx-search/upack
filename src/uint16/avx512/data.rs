...
/// Load 2, 512 bit registers holding 64 16-bit elements.
pub(crate) fn load_u16x64(block: &[u16; X64]) -> [__m512i; 2] {
...
#[target_feature(enable = "avx512f")]
/// Store 2, 512 bit registers holding 64 16-bit elements.
pub(crate) fn store_u16x64(block: &mut [u16; X64], data: [__m512i; 2]) {
