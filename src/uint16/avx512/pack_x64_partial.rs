...
pub(crate) unsafe fn to_u1(out: *mut u8, block: [__m512i; 2], _pack_n: usize) {
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u2(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let partially_packed = pack_u16_to_u8_ordered(block);
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u3(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let partially_packed = pack_u16_to_u8_ordered(block);
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u4(out: *mut u8, block: [__m512i; 2], _pack_n: usize) {
    let partially_packed = pack_u16_to_u8_ordered(block);
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u5(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let partially_packed = pack_u16_to_u8_ordered(block);
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u6(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let partially_packed = pack_u16_to_u8_ordered(block);
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u7(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let partially_packed = pack_u16_to_u8_ordered(block);
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u8(out: *mut u8, block: [__m512i; 2], _pack_n: usize) {
    let partially_packed = pack_u16_to_u8_ordered(block);
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u9(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u10(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let (hi, lo) = split_u16_ordered(block);
    unsafe { _mm512_storeu_epi8(out.add(0).cast(), lo) };
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u11(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let (hi, lo) = split_u16_ordered(block);
    unsafe { _mm512_storeu_epi8(out.add(0).cast(), lo) };
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u12(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let (hi, lo) = split_u16_ordered(block);
    unsafe { _mm512_storeu_epi8(out.add(0).cast(), lo) };
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u13(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let (hi, lo) = split_u16_ordered(block);
    unsafe { _mm512_storeu_epi8(out.add(0).cast(), lo) };
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u14(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let (hi, lo) = split_u16_ordered(block);
    unsafe { _mm512_storeu_epi8(out.add(0).cast(), lo) };
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u15(out: *mut u8, block: [__m512i; 2], pack_n: usize) {
    let (hi, lo) = split_u16_ordered(block);
    unsafe { _mm512_storeu_epi8(out.add(0).cast(), lo) };
...
/// - The runtime CPU must support the `avx512f` and `avx512bw` instructions.
pub(crate) unsafe fn to_u16(out: *mut u8, block: [__m512i; 2], _pack_n: usize) {
