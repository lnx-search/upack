...
pub unsafe fn from_u1(input: *const u8) -> [u32x8; 8] {
...
pub unsafe fn from_u2(input: *const u8) -> [u32x8; 8] {
...
unsafe fn unpack_u2_registers(input: *const u8) -> [u8x32; 2] {
    let packed = unsafe { _neon_load_u8x16(input) };
...
pub unsafe fn from_u3(input: *const u8) -> [u32x8; 8] {
...
unsafe fn unpack_u3_registers(input: *const u8) -> [u8x32; 2] {
    let packed_2bit = unsafe { _neon_load_u8x16(input.add(0)) };
...
pub unsafe fn from_u4(input: *const u8) -> [u32x8; 8] {
...
pub unsafe fn from_u5(input: *const u8) -> [u32x8; 8] {
...
pub unsafe fn from_u6(input: *const u8) -> [u32x8; 8] {
...
pub unsafe fn from_u7(input: *const u8) -> [u32x8; 8] {
