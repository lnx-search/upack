...
pub(super) unsafe fn from_u24(input: *const u8, read_n: usize) -> [__m512i; 4] {
    ...
    let offset = read_n * 2;
    let hi_bits = unsafe { _mm512_loadu_epi8(input.add(offset).cast()) };
    let mut hi_bits = unpack_u8_to_u32_ordered(hi_bits);
    hi_bits = slli_epi32::<16, 4>(hi_bits);
...
pub(super) unsafe fn from_u25(input: *const u8, read_n: usize) -> [__m512i; 4] {
    ...
    let hi_8bits = unsafe { _mm512_loadu_epi8(input.add(offset).cast()) };
...
mod tests {
    ...
    use crate::uint32::avx512::pack_x64_partial::*;
    ...
    fn test_saturated_unpack(
        #[case] bit_len: u8,
        #[case] unpacker: unsafe fn(*const u8, usize) -> [__m512i; 4],
    ) {
    ...
    #[case(17, avx2::pack_x64_partial::to_u17, from_u17)]
    #[case(18, avx2::pack_x64_partial::to_u18, from_u18)]
    #[case(19, avx2::pack_x64_partial::to_u19, from_u19)]
    #[case(20, avx2::pack_x64_partial::to_u20, from_u20)]
    #[case(21, avx2::pack_x64_partial::to_u21, from_u21)]
    #[case(22, avx2::pack_x64_partial::to_u22, from_u22)]
    #[case(23, avx2::pack_x64_partial::to_u23, from_u23)]
    #[case(24, avx2::pack_x64_partial::to_u24, from_u24)]
    #[case(25, avx2::pack_x64_partial::to_u25, from_u25)]
    #[case(26, avx2::pack_x64_partial::to_u26, from_u26)]
    #[case(27, avx2::pack_x64_partial::to_u27, from_u27)]
    #[case(28, avx2::pack_x64_partial::to_u28, from_u28)]
    #[case(29, avx2::pack_x64_partial::to_u29, from_u29)]
    #[case(30, avx2::pack_x64_partial::to_u30, from_u30)]
    #[case(31, avx2::pack_x64_partial::to_u31, from_u31)]
    #[case(32, avx2::pack_x64_partial::to_u32, from_u32)]
    #[cfg_attr(
        not(all(target_feature = "avx512f", target_feature = "avx512bw")),
        ignore
    )]
